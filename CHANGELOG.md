...
## [0.1.13](https://github.com/seyallius/toolkitrs/compare/v0.1.12...v0.1.13) - 2026-08-31

### Fixed

- *(gh-contrib)* support today/yesterday dates and TUI-safe logging

### Other

- Update README to indicate WIP status
...
- *(readme)* add gh-contrib section and update features list
